            ...
            <CardContent className="pt-6">
              ...
              {(searchQuery || selectedType || selectedStory) && (
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {selectedStory && <Badge variant="secondary">Story selected</Badge>}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">
                      {filteredQuestions.length === questions.length ? 'Total Questions' : 'Filtered Questions'}
                    </div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-success">
                      {new Set(filteredQuestions.map(q => q.questionType)).size}
                    </div>
                    <div className="text-sm text-muted-foreground">
                      Question Types
                    </div>
                      ...
                      <CardHeader>
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <CardTitle className="mb-2">{question.question}</CardTitle>
                            {question.storyTitle && (
                              <CardDescription>
