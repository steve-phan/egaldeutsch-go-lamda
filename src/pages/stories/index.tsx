...
const StoriesPage: React.FC = () => {
  ...
  const getUniqueTopics = (): string[] => {
    const allTopics = stories.flatMap((story) => story.topics);
        ...
        <div className="bg-card rounded-lg shadow-sm border border-border p-6 mb-8">
          ...
          {(searchQuery || selectedLevel || selectedTopic) && (
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {selectedTopic && (
                <Badge variant="secondary">Topic: {selectedTopic}</Badge>
              )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                ...
                <div>
                  <div className="text-3xl font-bold text-warning">
                    {new Set(filteredStories.flatMap((s) => s.topics)).size}
                  </div>
            ...
            {filteredStories.length === 0 ? (
              <div className="text-center py-12">
                <div className="max-w-md mx-auto">
                  ...
                  {stories.length === 0 ? (
                    <Button onClick={loadStories}>Refresh</Button>
                  ) : (
